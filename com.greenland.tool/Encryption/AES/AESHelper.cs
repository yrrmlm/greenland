...
namespace com.greenland.tool.Encryption.AES
{
    public class AESHelper
    {
        ...
        /// AES 加密key
        /// </summary>
        private const string AESKey = "Gree1and";
        ...
        /// <returns></returns>
        public static string AesEncrypt(string str, string key = AESKey)
        {
        ...
        /// <param name="key">密文</param>
        /// <returns></returns>
        public static string AesDecrypt(string str, string key = AESKey)
        {
            if (string.IsNullOrEmpty(str)) return null;
